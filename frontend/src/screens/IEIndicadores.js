...
export default function IEIndicadores() {
  ...
  return (
    <Container className="small-container2">
      <br></br>
      <h4 className="my-3">INDICADORES DEL SGIRS</h4>
      <br></br>
      <Form onSubmit>
        {/* INDICADOR 1 */}
          ...
          <thead>
            <tr>
              <th colSpan={2}>
                ...
                aprovechables generados en la Institución Educativa
              </th>
              <th className="columnas">Enero</th>
              <th className="columnas">Febrero</th>
              <th className="columnas">Marzo</th>
          ...
          <thead>
            <tr>
              <th colSpan={2}>
                ...
                a la cadena productiva de reciclaje por la Institución Educativa
              </th>
              <th className="columnas">Enero</th>
              <th className="columnas">Febrero</th>
              <th className="columnas">Marzo</th>
